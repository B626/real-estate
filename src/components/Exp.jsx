...
const Exp = () => {
  return (
    <section className="p-[20px_0_40px]">
      <div className="sm:max-w-[320px] sm:p-[0_15px] m-[0_auto] sm:flex flex-col ">
        ...
        <div className='mb-[40px]'>
          <ul className="flex flex-col sm:gap-[25px]">
            <li>
              <h3 className="font-[700] sm:text-[20px] sm:text-center sm:text-[#FFE500]">
                12 million properties
              </h3>
              <p className="sm:text-center sm:text-[12px] text-[#fff] p-[0_20px]">
